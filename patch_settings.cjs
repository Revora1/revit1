...
const targetMenu = `    { id: 'admob', icon: Tv, label: 'Google AdMob', description: 'Configure & test mobile ads' },`;
const replacementMenu = `    { id: 'whatsnew', icon: Sparkles, label: 'What\\'s New', description: 'Latest updates & giveaways' },
