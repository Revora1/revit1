...
export default function AdminScreen() {
  ...
  const addVideo = async () => {
    if (!newVideoTitle || !newVideoUrl) {
      return Alert.alert('Error', 'Title and Video URL are required');
    }
    setSavingMilestones(true);
    try {
      ...
      setAdminVideos(prev => [{ id: docRef.id, title: newVideoTitle, videoUrl: newVideoUrl, thumbnailUrl: newVideoThumbnail, createdAt: new Date() }, ...prev]);
      setNewVideoTitle('');
      setNewVideoUrl('');
            ...
            {activeTab === 'videos' && (
              <View style={styles.giveawayContainer}>
                ...
                <View style={styles.card}>
                  ...
                  <Text style={styles.inputLabel}>VIDEO URL (MP4 / HLS)</Text>
                  <TextInput style={[styles.input, {marginBottom: 12}]} value={newVideoUrl} onChangeText={setNewVideoUrl} placeholder="https://..." placeholderTextColor="#555" />
                  
                  <Text style={styles.inputLabel}>THUMBNAIL URL (OPTIONAL)</Text>
                  <TextInput style={styles.input} value={newVideoThumbnail} onChangeText={setNewVideoThumbnail} placeholder="https://..." placeholderTextColor="#555" />
                </View>
